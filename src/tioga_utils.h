...
void octant_children(uint8_t children_level, uint32_t idx, octant_full_t *q,
                     octant_full_t *c0, octant_full_t *c1, octant_full_t *c2,
                     octant_full_t *c3, octant_full_t *c4, octant_full_t *c5,
                     octant_full_t *c6, octant_full_t *c7);
void octant_children_neighbors(const octant_full_t *q, octant_full_t *c0,
                               octant_full_t *c1, octant_full_t *c2,
                               octant_full_t *c3, octant_full_t *c4,
                               octant_full_t *c5, octant_full_t *c6,
                               octant_full_t *c7);
...
void qcoord_to_vertex(qcoord_t x, qcoord_t y, qcoord_t z, double *vertices,
                      double vxyz[3]);
...
int triBoxOverlap(double boxcenter[3], double boxhalfsize[3], double *pt1,
