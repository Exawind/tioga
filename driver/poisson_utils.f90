...
subroutine deallocategrid(g)
 ...
 if (associated(g%ndc4)) deallocate(g%ndc4)
 if (associated(g%ndc5)) deallocate(g%ndc5)
 if (associated(g%ndc6)) deallocate(g%ndc6)
 if (associated(g%ndc8)) deallocate(g%ndc8)
 if (associated(g%wbcnode)) deallocate(g%wbcnode)
 if (associated(g%obcnode)) deallocate(g%obcnode)
