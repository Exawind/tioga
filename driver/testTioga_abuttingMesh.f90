!
! File:   testTioga_abuttingMesh.f90
! Author: akirby
!
! Created on November 25, 2023, 9:11 AM
!
! Tioga is a library for overset grid assembly on parallel distributed systems
! Copyright (C) 2015 Jay Sitaraman
!
program testTioga_abuttingMesh
  use gridtype
  use mpi
  implicit none
  ...
  call tioga_gmsh_reader(nnodes,xyz,nwbc,nobc)
  print*,"GMSH Nodes: ",nnodes,nwbc,nobc
  ...
  do ib=1,2
   g=>gr(ib)
   if (g%n6 > 0)  then
    call tioga_registergrid_data_mb(ib,g%bodytag(1),g%nv,g%x,g%iblank,g%nwbc,g%nobc,g%wbcnode,g%obcnode,ntypes,nv1,g%n6,g%ndc6)
   else if (g%n8 > 0) then
...
200 continue
  ...
  !
end program testTioga_abuttingMesh
